...
def fun_status(res_1: int, res_2: int) -> tuple:
    if (res_1 == 21 and res_2 != 21) or (res_1 < 21 < res_2) or (res_1 > res_2 and res_1 < 21) or (res_1 < res_2 and res_1>21):
        return 'Win', 'Lose'
    elif (res_2 == 21 and res_1 != 21) or (res_2 < 21 < res_1) or (res_2 > res_1 and res_2 < 21) or (res_2 < res_1 and res_2>21):
        return 'Lose', 'Win'
    elif res_1 == res_2:
        return 'Push', 'Push'
    return 'Lose', 'Lose'
    ...
    def black_jack_game_online_dealer(self):
        ...
        while True:
            ...
            if mode == 1:
                ...
                cv2.putText(frame1, f'{self.res_1} -> {self.status_1}', (10, 30), font, 1, (255, 255, 255), 1, cv2.LINE_AA)
            elif mode == 3:
                cv2.putText(frame1, f'{self.res_1}', (10, 30), font, 1, (255, 255, 255), 1, cv2.LINE_AA)
            elif mode == 4:
                cv2.putText(frame1, f'{self.res_1}', (10, 30), font, 1, (255, 255, 255), 1, cv2.LINE_AA)
            elif mode == 5:
                cv2.putText(frame1, f'{self.res_1}', (10, 30), font, 1, (255, 255, 255), 1, cv2.LINE_AA)
    ...
    def black_jack_game_online_player(self):
        ...
        while True:
            ...
            if mode == 1:
                ...
                cv2.putText(frame2, f'{self.res_2} -> {self.status_2}', (10, 30), font, 1, (255, 255, 255), 1, cv2.LINE_AA)
            elif mode == 3:
                cv2.putText(frame2, f'{self.res_2} - Move', (10, 30), font, 1, (255, 255, 255), 1, cv2.LINE_AA)
            elif mode == 4:
                cv2.putText(frame2, f'{self.res_2} - Pass', (10, 30), font, 1, (255, 255, 255), 1, cv2.LINE_AA)
            elif mode == 5:
                cv2.putText(frame2, f'{self.res_2} - Surrender', (10, 30), font, 1, (255, 255, 255), 1, cv2.LINE_AA)

            if mode == 1:
                ret1, buffer2 = cv2.imencode('.jpg', annotated_frame_2)
                frame_res = buffer2.tobytes()
            else:
                ret1, buffer2 = cv2.imencode('.jpg', frame2)
                frame_res = buffer2.tobytes()
